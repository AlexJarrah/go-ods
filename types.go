...
type manifestMarshal struct {
	...
	Text        string   `xml:",chardata" json:"text,omitempty"`
	Rdf         string   `xml:"xmlns:rdf,attr,omitempty" json:"rdf0,omitempty"`
	Description []struct {
		Text  string `xml:",chardata" json:"text,omitempty"`
		About string `xml:"rdf:about,attr,omitempty" json:"about,omitempty"`
		Type  struct {
			Text     string `xml:",chardata" json:"text,omitempty"`
			Resource string `xml:"rdf:resource,attr,omitempty" json:"resource,omitempty"`
		} `xml:"rdf:type" json:"type,omitempty"`
		HasPart struct {
			Text     string `xml:",chardata" json:"text,omitempty"`
			Ns0      string `xml:"xmlns:ns0,attr,omitempty" json:"ns0,omitempty"`
			Resource string `xml:"rdf:resource,attr,omitempty" json:"resource,omitempty"`
...
type metaMarshal struct {
	...
	AttrMeta string   `xml:"xmlns:meta,attr,omitempty" json:"attrMeta,omitempty"`
	...
	Meta     struct {
		...
		DocumentStatistic struct {
			Text        string `xml:",chardata" json:"text,omitempty"`
			TableCount  string `xml:"meta:table-count,attr,omitempty" json:"table-count,omitempty"`
			CellCount   string `xml:"meta:cell-count,attr,omitempty" json:"cell-count,omitempty"`
			ObjectCount string `xml:"meta:object-count,attr,omitempty" json:"object-count,omitempty"`
...
type stylesMarshal struct {
	...
	Styles struct {
		...
		DefaultStyle []struct {
			...
			ParagraphProperties struct {
				Text                       string `xml:",chardata" json:"text,omitempty"`
				TabStopDistance            string `xml:"style:tab-stop-distance,attr,omitempty" json:"tab-stop-distance,omitempty"`
				TextAutospace              string `xml:"style:text-autospace,attr,omitempty" json:"text-autospace,omitempty"`
				PunctuationWrap            string `xml:"style:punctuation-wrap,attr,omitempty" json:"punctuation-wrap,omitempty"`
				LineBreak                  string `xml:"style:line-break,attr,omitempty" json:"line-break,omitempty"`
				WritingMode                string `xml:"style:writing-mode,attr,omitempty" json:"writing-mode,omitempty"`
				FontIndependentLineSpacing string `xml:"style:font-independent-line-spacing,attr,omitempty" json:"font-independent-line-spacing,omitempty"`
				TabStops                   string `xml:"style:tab-stops"`
			} `xml:"style:paragraph-properties" json:"paragraph-properties,omitempty"`
			TextProperties struct {
				Text               string `xml:",chardata" json:"text,omitempty"`
				FontName           string `xml:"style:font-name,attr,omitempty" json:"font-name,omitempty"`
				FontSize           string `xml:"fo:font-size,attr,omitempty" json:"font-size,omitempty"`
				Language           string `xml:"fo:language,attr,omitempty" json:"language,omitempty"`
				Country            string `xml:"fo:country,attr,omitempty" json:"country,omitempty"`
				FontNameAsian      string `xml:"style:font-name-asian,attr,omitempty" json:"font-name-asian,omitempty"`
				FontSizeAsian      string `xml:"style:font-size-asian,attr,omitempty" json:"font-size-asian,omitempty"`
				LanguageAsian      string `xml:"style:language-asian,attr,omitempty" json:"language-asian,omitempty"`
				CountryAsian       string `xml:"style:country-asian,attr,omitempty" json:"country-asian,omitempty"`
				FontNameComplex    string `xml:"style:font-name-complex,attr,omitempty" json:"font-name-complex,omitempty"`
				FontSizeComplex    string `xml:"style:font-size-complex,attr,omitempty" json:"font-size-complex,omitempty"`
				LanguageComplex    string `xml:"style:language-complex,attr,omitempty" json:"language-complex,omitempty"`
				CountryComplex     string `xml:"style:country-complex,attr,omitempty" json:"country-complex,omitempty"`
				UseWindowFontColor string `xml:"style:use-window-font-color,attr,omitempty" json:"use-window-font-color,omitempty"`
				Opacity            string `xml:"loext:opacity,attr,omitempty" json:"opacity,omitempty"`
				FontFamily         string `xml:"fo:font-family,attr,omitempty" json:"font-family,omitempty"`
				FontFamilyGeneric  string `xml:"style:font-family-generic,attr,omitempty" json:"font-family-generic,omitempty"`
				FontPitch          string `xml:"style:font-pitch,attr,omitempty" json:"font-pitch,omitempty"`
				LetterKerning      string `xml:"style:letter-kerning,attr,omitempty" json:"letter-kerning,omitempty"`
			} `xml:"style:text-properties" json:"text-properties,omitempty"`
			GraphicProperties struct {
				Text          string `xml:",chardata" json:"text,omitempty"`
				StrokeColor   string `xml:"svg:stroke-color,attr,omitempty" json:"stroke-color,omitempty"`
				FillColor     string `xml:"draw:fill-color,attr,omitempty" json:"fill-color,omitempty"`
				WrapOption    string `xml:"fo:wrap-option,attr,omitempty" json:"wrap-option,omitempty"`
				ShadowOffsetX string `xml:"draw:shadow-offset-x,attr,omitempty" json:"shadow-offset-x,omitempty"`
				ShadowOffsetY string `xml:"draw:shadow-offset-y,attr,omitempty" json:"shadow-offset-y,omitempty"`
				WritingMode   string `xml:"style:writing-mode,attr,omitempty" json:"writing-mode,omitempty"`
		...
		Style []struct {
			...
			DisplayName       string `xml:"style:display-name,attr,omitempty" json:"display-name,omitempty"`
			GraphicProperties struct {
				Text              string `xml:",chardata" json:"text,omitempty"`
				Stroke            string `xml:"draw:stroke,attr,omitempty" json:"stroke,omitempty"`
				MarkerStart       string `xml:"draw:marker-start,attr,omitempty" json:"marker-start,omitempty"`
				MarkerStartWidth  string `xml:"draw:marker-start-width,attr,omitempty" json:"marker-start-width,omitempty"`
				MarkerStartCenter string `xml:"draw:marker-start-center,attr,omitempty" json:"marker-start-center,omitempty"`
				Fill              string `xml:"draw:fill,attr,omitempty" json:"fill,omitempty"`
				FillColor         string `xml:"draw:fill-color,attr,omitempty" json:"fill-color,omitempty"`
				AutoGrowHeight    string `xml:"draw:auto-grow-height,attr,omitempty" json:"auto-grow-height,omitempty"`
				AutoGrowWidth     string `xml:"draw:auto-grow-width,attr,omitempty" json:"auto-grow-width,omitempty"`
				PaddingTop        string `xml:"fo:padding-top,attr,omitempty" json:"padding-top,omitempty"`
				PaddingBottom     string `xml:"fo:padding-bottom,attr,omitempty" json:"padding-bottom,omitempty"`
				PaddingLeft       string `xml:"fo:padding-left,attr,omitempty" json:"padding-left,omitempty"`
				PaddingRight      string `xml:"fo:padding-right,attr,omitempty" json:"padding-right,omitempty"`
				Shadow            string `xml:"draw:shadow,attr,omitempty" json:"shadow,omitempty"`
				ShadowOffsetX     string `xml:"draw:shadow-offset-x,attr,omitempty" json:"shadow-offset-x,omitempty"`
				ShadowOffsetY     string `xml:"draw:shadow-offset-y,attr,omitempty" json:"shadow-offset-y,omitempty"`
			} `xml:"style:graphic-properties" json:"graphic-properties,omitempty"`
			TextProperties struct {
				...
				FontSize               string `xml:"fo:font-size,attr,omitempty" json:"font-size,omitempty"`
				FontNameAsian          string `xml:"style:font-name-asian,attr,omitempty" json:"font-name-asian,omitempty"`
				FontFamilyAsian        string `xml:"style:font-family-asian,attr,omitempty" json:"font-family-asian,omitempty"`
				FontFamilyGenericAsian string `xml:"style:font-family-generic-asian,attr,omitempty" json:"font-family-generic-asian,omitempty"`
				FontPitchAsian         string `xml:"style:font-pitch-asian,attr,omitempty" json:"font-pitch-asian,omitempty"`
				FontSizeAsian          string `xml:"style:font-size-asian,attr,omitempty" json:"font-size-asian,omitempty"`
				FontNameComplex        string `xml:"style:font-name-complex,attr,omitempty" json:"font-name-complex,omitempty"`
				FontFamilyComplex      string `xml:"style:font-family-complex,attr,omitempty" json:"font-family-complex,omitempty"`
				FontSizeComplex        string `xml:"style:font-size-complex,attr,omitempty" json:"font-size-complex,omitempty"`
				Color                  string `xml:"fo:color,attr,omitempty" json:"color,omitempty"`
				FontStyle              string `xml:"fo:font-style,attr,omitempty" json:"font-style,omitempty"`
				FontWeight             string `xml:"fo:font-weight,attr,omitempty" json:"font-weight,omitempty"`
				TextUnderlineStyle     string `xml:"style:text-underline-style,attr,omitempty" json:"text-underline-style,omitempty"`
				TextUnderlineWidth     string `xml:"style:text-underline-width,attr,omitempty" json:"text-underline-width,omitempty"`
				TextUnderlineColor     string `xml:"style:text-underline-color,attr,omitempty" json:"text-underline-color,omitempty"`
				FontStyleAsian         string `xml:"style:font-style-asian,attr,omitempty" json:"font-style-asian,omitempty"`
				FontWeightAsian        string `xml:"style:font-weight-asian,attr,omitempty" json:"font-weight-asian,omitempty"`
				FontStyleComplex       string `xml:"style:font-style-complex,attr,omitempty" json:"font-style-complex,omitempty"`
				FontWeightComplex      string `xml:"style:font-weight-complex,attr,omitempty" json:"font-weight-complex,omitempty"`
			} `xml:"style:text-properties" json:"text-properties,omitempty"`
			TableCellProperties struct {
				Text            string `xml:",chardata" json:"text,omitempty"`
				RotationAlign   string `xml:"style:rotation-align,attr,omitempty" json:"rotation-align,omitempty"`
				VerticalAlign   string `xml:"style:vertical-align,attr,omitempty" json:"vertical-align,omitempty"`
				BackgroundColor string `xml:"fo:background-color,attr,omitempty" json:"background-color,omitempty"`
				DiagonalBlTr    string `xml:"style:diagonal-bl-tr,attr,omitempty" json:"diagonal-bl-tr,omitempty"`
				DiagonalTlBr    string `xml:"style:diagonal-tl-br,attr,omitempty" json:"diagonal-tl-br,omitempty"`
				Border          string `xml:"fo:border,attr,omitempty" json:"border,omitempty"`
				WrapOption      string `xml:"fo:wrap-option,attr,omitempty" json:"wrap-option,omitempty"`
				ShrinkToFit     string `xml:"style:shrink-to-fit,attr,omitempty" json:"shrink-to-fit,omitempty"`
		...
		NumberStyle []struct {
			...
			ScientificNumber struct {
				...
				MinDecimalPlaces   string `xml:"number:min-decimal-places,attr,omitempty" json:"min-decimal-places,omitempty"`
				MinIntegerDigits   string `xml:"number:min-integer-digits,attr,omitempty" json:"min-integer-digits,omitempty"`
				MinExponentDigits  string `xml:"number:min-exponent-digits,attr,omitempty" json:"min-exponent-digits,omitempty"`
				ExponentInterval   string `xml:"number:exponent-interval,attr,omitempty" json:"exponent-interval,omitempty"`
				ForcedExponentSign string `xml:"number:forced-exponent-sign,attr,omitempty" json:"forced-exponent-sign,omitempty"`
		...
		TimeStyle []struct {
			Chardata           string `xml:",chardata" json:"chardata,omitempty"`
			Name               string `xml:"style:name,attr,omitempty" json:"name,omitempty"`
			TruncateOnOverflow string `xml:"number:truncate-on-overflow,attr,omitempty" json:"truncate-on-overflow,omitempty"`
			Language           string `xml:"number:language,attr,omitempty" json:"language,omitempty"`
			Country            string `xml:"number:country,attr,omitempty" json:"country,omitempty"`
			Minutes            struct {
				Text  string `xml:",chardata" json:"text,omitempty"`
		...
		DateStyle []struct {
			...
			Month    struct {
				Text    string `xml:",chardata" json:"text,omitempty"`
				Textual string `xml:"number:textual,attr,omitempty" json:"textual,omitempty"`
		...
		Marker struct {
			Text        string `xml:",chardata" json:"text,omitempty"`
			Name        string `xml:"draw:name,attr,omitempty" json:"name,omitempty"`
			DisplayName string `xml:"draw:display-name,attr,omitempty" json:"display-name,omitempty"`
			ViewBox     string `xml:"svg:viewBox,attr,omitempty" json:"viewbox,omitempty"`
			D           string `xml:"svg:d,attr,omitempty" json:"d,omitempty"`
	...
	AutomaticStyles struct {
		...
		PageLayout []struct {
			...
			PageLayoutProperties struct {
				Text             string `xml:",chardata" json:"text,omitempty"`
				FirstPageNumber  string `xml:"style:first-page-number,attr,omitempty" json:"first-page-number,omitempty"`
				WritingMode      string `xml:"style:writing-mode,attr,omitempty" json:"writing-mode,omitempty"`
				NumFormat        string `xml:"style:num-format,attr,omitempty" json:"num-format,omitempty"`
				PrintOrientation string `xml:"style:print-orientation,attr,omitempty" json:"print-orientation,omitempty"`
				MarginTop        string `xml:"fo:margin-top,attr,omitempty" json:"margin-top,omitempty"`
				MarginBottom     string `xml:"fo:margin-bottom,attr,omitempty" json:"margin-bottom,omitempty"`
				MarginLeft       string `xml:"fo:margin-left,attr,omitempty" json:"margin-left,omitempty"`
				MarginRight      string `xml:"fo:margin-right,attr,omitempty" json:"margin-right,omitempty"`
				PrintPageOrder   string `xml:"style:print-page-order,attr,omitempty" json:"print-page-order,omitempty"`
				ScaleTo          string `xml:"style:scale-to,attr,omitempty" json:"scale-to,omitempty"`
				Print            string `xml:"style:print,attr,omitempty" json:"print,omitempty"`
			} `xml:"style:page-layout-properties" json:"page-layout-properties,omitempty"`
			HeaderStyle struct {
				Text                   string `xml:",chardata" json:"text,omitempty"`
				HeaderFooterProperties struct {
					Text            string `xml:",chardata" json:"text,omitempty"`
					MinHeight       string `xml:"fo:min-height,attr,omitempty" json:"min-height,omitempty"`
					MarginLeft      string `xml:"fo:margin-left,attr,omitempty" json:"margin-left,omitempty"`
					MarginRight     string `xml:"fo:margin-right,attr,omitempty" json:"margin-right,omitempty"`
					MarginBottom    string `xml:"fo:margin-bottom,attr,omitempty" json:"margin-bottom,omitempty"`
					Border          string `xml:"fo:border,attr,omitempty" json:"border,omitempty"`
					Padding         string `xml:"fo:padding,attr,omitempty" json:"padding,omitempty"`
					BackgroundColor string `xml:"fo:background-color,attr,omitempty" json:"background-color,omitempty"`
	...
	MasterStyles struct {
		...
		MasterPage []struct {
			Text           string `xml:",chardata" json:"text,omitempty"`
			Name           string `xml:"style:name,attr,omitempty" json:"name,omitempty"`
			PageLayoutName string `xml:"style:page-layout-name,attr,omitempty" json:"page-layout-name,omitempty"`
			DisplayName    string `xml:"style:display-name,attr,omitempty" json:"display-name,omitempty"`
			Header         struct {
				Text    string `xml:",chardata" json:"text,omitempty"`
				Display string `xml:"style:display,attr,omitempty" json:"display,omitempty"`
				P       struct {
					Text      string `xml:",chardata" json:"text,omitempty"`
				...
				RegionRight struct {
					...
					P    struct {
						...
						Date struct {
							...
							DateValue     string `xml:"text:date-value,attr,omitempty" json:"date-value,omitempty"`
						} `xml:"text:date" json:"date,omitempty"`
						Time struct {
							Text          string `xml:",chardata" json:"text,omitempty"`
							DataStyleName string `xml:"style:data-style-name,attr,omitempty" json:"data-style-name,omitempty"`
							TimeValue     string `xml:"text:time-value,attr,omitempty" json:"time-value,omitempty"`
...
type settingsMarshal struct {
	...
	Text     string   `xml:",chardata" json:"text,omitempty"`
	Config   string   `xml:"xmlns:config,attr,omitempty" json:"config,omitempty"`
	Xlink    string   `xml:"xmlns:xlink,attr,omitempty" json:"xlink,omitempty"`
	Ooo      string   `xml:"xmlns:ooo,attr,omitempty" json:"ooo,omitempty"`
	Office   string   `xml:"xmlns:office,attr,omitempty" json:"office,omitempty"`
	Version  string   `xml:"office:version,attr,omitempty" json:"version,omitempty"`
	Settings struct {
		...
		ConfigItemSet []struct {
			Text       string `xml:",chardata" json:"text,omitempty"`
			Name       string `xml:"config:name,attr,omitempty" json:"name,omitempty"`
			ConfigItem []struct {
				Text string `xml:",chardata" json:"text,omitempty"`
				Name string `xml:"config:name,attr,omitempty" json:"name,omitempty"`
				Type string `xml:"config:type,attr,omitempty" json:"type,omitempty"`
